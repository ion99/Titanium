...
// in simulator we redefine to format for myFirsClassicApp Developer console
...
{\
	NSString * exceptionName = [@"org.myfirsclassicapp." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.myfirsclassicapp";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UImyFirsClassicAppNativeItemNone = -1, 
	UImyFirsClassicAppNativeItemSpinner = -2,
	UImyFirsClassicAppNativeItemProgressBar = -3,
	
	UImyFirsClassicAppNativeItemSlider = -4,
	UImyFirsClassicAppNativeItemSwitch = -5,
	UImyFirsClassicAppNativeItemMultiButton = -6,
	UImyFirsClassicAppNativeItemSegmented = -7,
	
	UImyFirsClassicAppNativeItemTextView = -8,
	UImyFirsClassicAppNativeItemTextField = -9,
	UImyFirsClassicAppNativeItemSearchBar = -10,
	
	UImyFirsClassicAppNativeItemPicker = -11,
	UImyFirsClassicAppNativeItemDatePicker = -12,
	
	UImyFirsClassicAppNativeItemInfoLight = -13,
	UImyFirsClassicAppNativeItemInfoDark = -14,
	
	UImyFirsClassicAppNativeItemDisclosure = -15,
	
	UImyFirsClassicAppNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all myFirsClassicApp instances of
