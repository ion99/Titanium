...
//Rare exceptions to indicate a bug in the _myfirsclassicapp code (Eg, function that a subclass should have implemented)
...
/**
 The base class for myFirsClassicApp proxies.
 */
