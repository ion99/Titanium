...
//@interface myFirsClassicAppObject : NSObject
//@end

@interface myFirsClassicAppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[myFirsClassicAppObject class]])
		{
			for (NSString *key in [[(myFirsClassicAppObject*)o modules] allKeys])
			{
