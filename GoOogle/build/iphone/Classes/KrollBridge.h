...
@interface myFirsClassicAppObject : KrollCoverageObject {
#else
@interface myFirsClassicAppObject : KrollObject {
#endif
@private
...
extern NSString * myFirsClassicApp$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	myFirsClassicAppObject *_myfirsclassicapp;
    KrollObject* console;
	BOOL shutdown;
